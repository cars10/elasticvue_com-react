  ...
  return (
    <ButtonWrapper full={full} wrapperRef={dropdownRef}>
      <>
        <button
          onClick={toggle}
          className={`rounded-t ${!open ? 'rounded-b' : ''} ${full ? 'w-full' : ''} ${center ? 'justify-center' : ''} cursor-pointer bg-primary px-3 py-2 text-white shadow-sm hover:bg-primary-light dark:bg-primary-intense h-10 flex items-center`}
          role="button"
          rel="noopener"
        >
          <Image
