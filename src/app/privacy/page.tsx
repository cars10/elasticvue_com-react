    ...
    <>
      <section className="mx-auto mb-16 w-[92%] max-w-[1640px] text-white lg:w-[80%]">
        <div className="my-4">
          ...
          <p>
            Elasticvue (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;)
            operates the https://elasticvue.com/ website (the
            &quot;Service&quot;).
          </p>
          <p>
            ...
            Elasticvue is created with the help of the{' '}
          ...
          <h3 className="my-4 text-xl font-bold">Types of Data Collected</h3>
          ...
          <h3 className="my-4 text-xl font-bold">Use of Data</h3>
          ...
          <h3 className="my-4 text-xl font-bold">Transfer Of Data</h3>
          <p>
          ...
          <p>
            Elasticvue will take all steps reasonably necessary to ensure that
          ...
          <h3 className="my-4 text-xl font-bold">Disclosure Of Data</h3>

          <h4 className="my-4 text-xl font-bold">Legal Requirements</h4>
          <p>
            Elasticvue may disclose your Personal Data in the good faith belief
            that such action is necessary to:
          </p>
          <ul className="list-disc pl-5">
            <li className="mb-2">To comply with a legal obligation</li>
            <li className="mb-2">
              To protect and defend the rights or property of Elasticvue
            </li>
            <li className="mb-2">
          ...
          <h3 className="my-4 text-xl font-bold">Security Of Data</h3>
          <p>
          ...
          <h3 className="my-4 text-xl font-bold">Service Providers</h3>
          <p>
          ...
          <h3 className="my-4 text-xl font-bold">Links To Other Sites</h3>
          <p>
