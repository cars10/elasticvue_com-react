export default function privacy() {
  return (
    <>
      <section className="lg:w-[70%] w-[92%] max-w-[1344px] mx-auto text-white mb-16">
        <div className="my-4">
          <h1 className="text-3xl mb-4 font-bold">Privacy Policy</h1>
          <p>Effective date: February 25, 2019</p>
          <p>Elasticvue (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;) operates the https://elasticvue.com/ website (the &quot;Service&quot;).</p>
          <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when
            you use our Service and the choices you have associated with that data. Our Privacy Policy for
            Elasticvue is created with the help of the <a href="https://www.freeprivacypolicy.com/">Free Privacy
              Policy website</a>.</p>
          <p>We use your data to provide and improve the Service. By using the Service, you agree to the collection
            ...
            https://elasticvue.com/</p>


          <h2 className="text-2xl my-4 font-bold">Information Collection And Use</h2>

          <p>We collect several different types of information for various purposes to provide and improve our Service
            to you.</p>

          <h3 className="text-xl my-4 font-bold">Types of Data Collected</h3>

          <h4 className="my-2">Usage Data</h4>

          <p>We may collect information how the Service is accessed and used (&quot;Usage Data&quot;). This Usage Data may
          ...
          <h3 className="text-xl my-4 font-bold">Use of Data</h3>

          <p>Elasticvue uses the collected data for various purposes:</p>
          ...
          <h3 className="text-xl my-4 font-bold">Transfer Of Data</h3>
          ...
          <p>If you are located outside Germany and choose to provide information to us, please note that we transfer
            the data, including Personal Data, to Germany and process it there.</p>
          ...
          <p>Elasticvue will take all steps reasonably necessary to ensure that your data is treated securely and in
          ...
          <h3 className="text-xl my-4 font-bold">Disclosure Of Data</h3>

          <h4 className="text-xl my-4 font-bold">Legal Requirements</h4>
          <p>Elasticvue may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
          <ul className="list-disc pl-5">
            <li className="mb-2">To comply with a legal obligation</li>
            <li className="mb-2">To protect and defend the rights or property of Elasticvue</li>
          ...
          <h3 className="text-xl my-4 font-bold">Security Of Data</h3>
          ...
          <h3 className="text-xl my-4 font-bold">Service Providers</h3>
          ...
          <h3 className="text-xl my-4 font-bold">Links To Other Sites</h3>
          ...
          <h3 className="text-xl my-4 font-bold">Changes To This Privacy Policy</h3>
